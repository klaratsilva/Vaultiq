      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="col-span-1 sm:col-span-2">
          <div className="flex flex-col">
            <span className="text-sm text-gray-100 ">Balance</span>
        ...
        <div className="col-span-1 sm:col-span-2">
          <div className="flex flex-col">
            <span className="text-sm  text-gray-100">Account ID</span>
        ...
        <div className="flex flex-col">
          <span className="text-sm text-gray-100">Currency</span>
